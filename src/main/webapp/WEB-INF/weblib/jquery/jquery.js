    ...
    typeof window !== "undefined" ? window : this,
        function (window, noGlobal) {
            ...
            var Sizzle =
                ...
                (function (window) {
                    ...
                    setDocument = Sizzle.setDocument = function (node) {
                        ...
                        contains = hasCompare
                        || rnative.test(docElem.contains) ? function (a, b) {
                                ...
                                if (fn.length > 1) {
                                    ...
                                    return Expr.setFilters
                                        .hasOwnProperty(pseudo
                                            .toLowerCase()) ? markFunction(function (seed, matches) {
                    ...
                    function matcherFromTokens(tokens) {
                        var checkContext, matcher, j, len = tokens.length,
                            leadingRelative = Expr.relative[tokens[0].type], implicitRelative = leadingRelative
            ...
            var nodeNames = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|"
                ...
                rinlinejQuery = / jQuery\d+="(?:null|\d+)"/g, rnoshimcache = new RegExp(
                    "<(?:" + nodeNames + ")[\\s/>]", "i"), rleadingWhitespace = /^\s+/,
                rxhtmlTag = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
                rtagName = /<([\w:]+)/, rtbody = /<tbody/i, rhtml = /<|&#?\w+;/,
            ...
            jQuery.fn
                .extend({
                    ...
                    domManip: function (args, callback) {
                        ...
                        var first, node, hasScripts, scripts, doc, fragment, i = 0, l = this.length, set = this,
                            iNoClone = l - 1, value = args[0], isFunction = jQuery
                                .isFunction(value);
            ...
            (function () {
                ...
                var div, style, a, pixelPositionVal, boxSizingReliableVal, reliableHiddenOffsetsVal,
            ...
            function getWidthOrHeight(elem, name, extra) {
                ...
                // use the active box-sizing support to add/subtract
                // irrelevant styles
            ...
            function defaultPrefilter(elem, props, opts) {
                ...
                var prop, value, toggle, tween, hooks, oldfire, display, checkDisplay, anim = this, orig = {},
                    style = elem.style, hidden = elem.nodeType
...
(function (window) {
    var queryString = function (key, win) {
        win = win || window;
    ...
    var ifnau = function (v, t) {
        if (typeof v === "undefined" || v === null) {
            return t || "";
        }
        return v;
    };
    var checkRadio = function (name, checkValue) {
        var radios = null;
        if (typeof name === "string") {
            radios = document.getElementsByName(name);
        } else if (name instanceof NodeList) {
            radios = name;
        }
        if (radios) {
            for (var i = radios.length; i-- > 0;) {
                if (radios[i].value === checkValue) {

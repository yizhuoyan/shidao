...
//onload
    $(function () {
        //全局变量赋值
        $tableTreeEL = $("#knowledgePointTableTree");
    ...
    var updateKnowledgePointTableTree = function () {
        $tableTreeEL.fancytree({
            source: {
                url: "/questionhub/knowledgePoint/list",
                cache: true
            },
            ...
            renderColumns: function (evt, ctx) {
                ...
                cells[2].textContent = String(model.childrenAmount);

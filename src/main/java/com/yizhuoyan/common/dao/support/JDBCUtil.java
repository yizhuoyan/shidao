...
public class JDBCUtil {
    ...
    public static final Timestamp toTimestamp(Date d) {
        if (d == null) return null;
        return new Timestamp(d.getTime());
    }

    public static final Timestamp toTimestamp(Instant d) {
        if (d == null) return null;
    ...
    public static final LocalDateTime toLocalDateTime(Timestamp t) {
        if (t == null) return null;
        return t.toLocalDateTime();
    }

    public static final LocalTime toLocalTime(Time t) {
        if (t == null) return null;
        return t.toLocalTime();
    }

    public static final LocalDate toLocalDate(java.sql.Date t) {
        if (t == null) return null;

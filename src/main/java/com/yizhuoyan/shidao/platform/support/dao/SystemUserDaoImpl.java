 ...
 */
@Repository
public class SystemUserDaoImpl extends SingleTableDaoSupport<SystemUserDo> implements SystemUserDao{
...
@Override
public void obj2row(PreparedStatement ps, SystemUserDo m) throws Exception{
  int i = 1;
...
public List<SystemUserDo> selectByRoleId(String roleId) throws Exception{
  ...
  return this.executesQuerySql(sql, this::row2obj, SystemUserDo.STATUS_DELETED,roleId);
}

@Override
protected SystemUserDo row2obj(ResultSet rs) throws Exception{
  SystemUserDo m = new SystemUserDo();
  int i = 1;
